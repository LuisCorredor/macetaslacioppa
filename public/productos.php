            ...
            <div class="text-page">
                ...
                <script>
                    function mostrarModelos(e) {
                        $(location).attr('href', 'modelos-productos.php?p=' + e);
                    }
                </script>
                <h2 class="no-bg margin-top-0"><span class="black">Categor&iacute;as de Productos</span></h2>
                <div class="row">
                    <?php foreach ($categories as $category) : ?>
                    <div class="col-sm-6 col-md-4 frame-boxes">
                        <div id="tetris" onclick="mostrarModelos('<?php echo $category->slug ?>')">
                            <h3><?php echo $category->name ?></h3>
                            <img src="<?php echo $category->image_path ?>" class="full-width">
                        </div>
                    </div>
                    <?php endforeach; ?>
